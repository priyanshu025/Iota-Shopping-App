...
import com.example.iotashopping.ComponentActivity;
...
public class ProductDetailsActivity extends BaseActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        product_image.setOnClickListener(this::onClick);
    ...
    public void onClick(View v) {
       ...
       if(v.getId()==R.id.iv_product_detail_image){
           Intent intent=new Intent(this, ComponentActivity.class);
           intent.putExtra("title", mProducts.getProductTitle());
           startActivity(intent);
       }
    }
}